...
{
    /// <summary>
    /// SalesDeliveryDetail.xaml 的交互逻辑
    /// </summary>
    public sealed partial class SalesDeliveryDetail
    {
        #region Property
        ...
        public SalesDeliveryDetail()
        {
            ...
            VM = new DeliveryVM(DeliveryType.InternalMDBOL);
            BindData();
        }

        public SalesDeliveryDetail(int deliveryId)
        {
            InitializeComponent();
            ModuleName = "SalesDelivery";
        ...
        private void Save(object sender, RoutedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                //TODO:调试后删除
                //Logger.write("新增发货单失败，" + ex.Message);
                //if (ex.InnerException != null)
                //    Logger.write("新增发货单失败，" + ex.InnerException.Message);
            }
        }
        ...
        private void BtnAddClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                VM.AddDeliveryLine(ModuleName, DeliveryType.InternalMDBOL);
                RefreshDeliveryLines();
            }
        }
        ...
        private void DeliveryLineEditExecuted(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if (id != 0)
            {
                VM.EditDeliveryLine(id, ModuleName, DeliveryType.InternalMDBOL);
                RefreshDeliveryLines();
            }
        }
