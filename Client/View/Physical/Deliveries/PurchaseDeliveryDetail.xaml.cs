...
{
    /// <summary>
    /// PurchaseDeliveryDetail.xaml 的交互逻辑
    /// </summary>
    public sealed partial class PurchaseDeliveryDetail
    {
        #region Property
        ...
        private void BtnAddClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                VM.AddDeliveryLine(ModuleName, DeliveryType.InternalTDBOL);
                RefreshDeliveryLines();
            }
        }
        ...
        private void DeliveryLineEditExecuted(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if (id != 0)
            {
                VM.EditDeliveryLine(id, ModuleName, DeliveryType.InternalTDBOL);
                RefreshDeliveryLines();
            }
        }
