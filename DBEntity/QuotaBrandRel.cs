...
namespace DBEntity
{
    ...
    public partial class QuotaBrandRel: IObjectWithChangeTracker, INotifyPropertyChanged, IEntity
    {
        ...
        private void FixupBrand(Brand previousValue, bool skipKeys = false)
        {
            ...
            if (Brand != null)
            {
                if (!Brand.QuotaBrandRels.Contains(this))
                {
                    Brand.QuotaBrandRels.Add(this);
                }
        ...
        private void FixupQuota(Quota previousValue)
        {
            ...
            if (Quota != null)
            {
                if (!Quota.QuotaBrandRels.Contains(this))
                {
                    Quota.QuotaBrandRels.Add(this);
                }
        ...
        private void FixupSpecification(Specification previousValue, bool skipKeys = false)
        {
            ...
            {
                if (!Specification.QuotaBrandRels.Contains(this))
                {
                    Specification.QuotaBrandRels.Add(this);
                }
