...
namespace DBEntity
{
    ...
    public partial class Specification: IObjectWithChangeTracker, INotifyPropertyChanged, IEntity
    {
        ...
        private void FixupCommodity(Commodity previousValue)
        {
            ...
            if (previousValue != null && previousValue.Specifications.Contains(this))
            {
            ...
            if (Commodity != null)
            {
                if (!Commodity.Specifications.Contains(this))
                {
                    Commodity.Specifications.Add(this);
                }
        ...
        private void FixupCommodityType(CommodityType previousValue)
        {
            ...
            {
                if (!CommodityType.Specifications.Contains(this))
                {
                    CommodityType.Specifications.Add(this);
                }
        ...
        private void FixupQuotas(object sender, NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.OldItems != null)
            {
                ...
                {
                    if (ReferenceEquals(item.Specification, this))
                    {
