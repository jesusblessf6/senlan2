...
namespace DBEntity
{
    ...
    public partial class StorageFeeRule: IObjectWithChangeTracker, INotifyPropertyChanged, IEntity
    {
        ...
        private Nullable<decimal> _pricePerUnit;
        ...
        private void FixupCommodity(Commodity previousValue)
        {
            ...
            if (previousValue != null && previousValue.StorageFeeRules.Contains(this))
            {
                previousValue.StorageFeeRules.Remove(this);
            }
    
            if (Commodity != null)
            {
                if (!Commodity.StorageFeeRules.Contains(this))
                {
                    Commodity.StorageFeeRules.Add(this);
                }
        ...
        private void FixupWarehouse(Warehouse previousValue)
        {
            ...
            if (Warehouse != null)
            {
                if (!Warehouse.StorageFeeRules.Contains(this))
                {
                    Warehouse.StorageFeeRules.Add(this);
                }
