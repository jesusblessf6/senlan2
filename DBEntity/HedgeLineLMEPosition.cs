...
namespace DBEntity
{
    ...
    public partial class HedgeLineLMEPosition: IObjectWithChangeTracker, INotifyPropertyChanged, IEntity
    {
        ...
        [DataMember]
        public int LMEPositionId
        {
            get { return _lMEPositionId; }
            set
            {
                if (_lMEPositionId != value)
                {
                    ChangeTracker.RecordOriginalValue("LMEPositionId", _lMEPositionId);
                    if (!IsDeserializing)
                    {
                        if (LMEPosition != null && LMEPosition.Id != value)
                        {
                            LMEPosition = null;
                        }
                    }
                    _lMEPositionId = value;
                    OnPropertyChanged("LMEPositionId");
                }
            }
        }
        private int _lMEPositionId;
        ...
        [DataMember]
        public LMEPosition LMEPosition
        {
            get { return _lMEPosition; }
            set
            {
                if (!ReferenceEquals(_lMEPosition, value))
                {
                    var previousValue = _lMEPosition;
                    _lMEPosition = value;
                    FixupLMEPosition(previousValue);
                    OnNavigationPropertyChanged("LMEPosition");
                }
            }
        }
        private LMEPosition _lMEPosition;
