...
namespace DBEntity
{
    ...
    public partial class Rate: IObjectWithChangeTracker, INotifyPropertyChanged, IEntity
    {
        ...
        public int ForeignCurrencyId
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("ForeignCurrencyId", _foreignCurrencyId);
                    if (!IsDeserializing)
                    {
                    ...
                    OnPropertyChanged("ForeignCurrencyId");
                }
            }
        }
        ...
        private void FixupCurrency(Currency previousValue)
        {
            ...
            if (Currency != null)
            {
                if (!Currency.Rates.Contains(this))
                {
                    Currency.Rates.Add(this);
                }
