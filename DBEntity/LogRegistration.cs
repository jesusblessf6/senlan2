...
namespace DBEntity
{
    ...
    public partial class LogRegistration: IObjectWithChangeTracker, INotifyPropertyChanged, IEntity
    {
        ...
        private void FixupDocument(Document previousValue)
        {
            ...
            if (previousValue != null && previousValue.LogRegistrations.Contains(this))
            {
                previousValue.LogRegistrations.Remove(this);
            }
    
            if (Document != null)
            {
                if (!Document.LogRegistrations.Contains(this))
                {
                    Document.LogRegistrations.Add(this);
                }
        ...
        private void FixupLogAction(LogAction previousValue)
        {
            ...
            if (LogAction != null)
            {
                if (!LogAction.LogRegistrations.Contains(this))
                {
                    LogAction.LogRegistrations.Add(this);
                }
        ...
        private void FixupUser(User previousValue)
        {
            ...
            if (User != null)
            {
                if (!User.LogRegistrations.Contains(this))
                {
                    User.LogRegistrations.Add(this);
                }
