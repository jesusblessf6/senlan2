...
{
    public class ManualPricingHandler : BasePricingHandler
    {
        ...
        public override void Update()
        {
            ...
            if ((oldQuota != null && oldQuota.PricingType != Quota.PricingType) || CTX.Pricings.Count(o => o.QuotaId == Quota.Id && !o.IsDeleted) == 0)
            {
                base.Update();
            }
        }
